...
#----------------------------------------------------------------------
def grab_inputs(base_url, cribl_auth_token, worker_group, cribl_configuration_item):
  url = f"{base_url}/m/{worker_group}/system/{cribl_configuration_item}"
...
def list_cribl_inputs(cribl_auth_token):
  ...
  print(worker_group)
  inputs_json = grab_inputs(base_url, cribl_auth_token, worker_group, 'inputs')
  list_inputs(inputs_json)
